...
const faqs = [
  ...
  },
  {
    ...
    a: '저는 갈아탔고 잘한 선택이었다고 생각합니다. 도약계좌 기여금보다 미래적금 기여금이 더 높고 금리도 유리해서, 남은 기간 기준으로 약 50만원 이상 이득입니다. 단, 도약계좌 해지 시 이미 받은 기여금은 반환해야 하니 꼼꼼히 계산해보세요.',
  },
  {
    q: 'K-패스는 어떻게 신청하나요?',
          ...
          <div className="space-y-5">
            ...
            <Card>
              <div className="p-4">
                ...
                <div className="text-[12px] text-text leading-relaxed space-y-2">
                  <p>
                    청년도약계좌를 유지하던 중에 청년미래적금이 출시됐습니다. 기여금이 더 높고
                    금리도 유리하다는 걸 알고 비교 계산을 해봤는데, 갈아타는 게 확실히
                    이득이더라고요.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    계산됩니다. 금리 차이까지 합치면 더 차이 날 수 있고요. 지금 시점에서 보면
                    갈아타길 잘한 것 같습니다.
                  </p>
                </div>

                <div className="mt-3 bg-amber-bg rounded p-3 text-[11px] text-amber">
                  <span className="font-bold">주의:</span> 도약계좌 해지 시 이미 받은 기여금은 환수될 수 있습니다. 남은 기간과 이미 받은 기여금을 꼭 계산해본 뒤에 결정하세요. 저는 유지 기간이 길지 않아서 갈아타는 게 유리했습니다.
                </div>
              </div>
            </Card>
